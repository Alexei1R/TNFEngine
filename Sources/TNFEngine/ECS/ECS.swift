...
public final class Registry {
    ...
    // NOTE: View system for querying entities
    public struct View<Components> {
    ...
    @inline(__always)
    public func view<T1: Component>(requiring component1: T1.Type) -> View<(T1.Type)> {
        return View(registry: self, componentTypes: [ObjectIdentifier(T1.self)])
    }

    @inline(__always)
    public func view<T1: Component, T2: Component>(
        requiring component1: T1.Type,
        _ component2: T2.Type
    ) -> View<(T1.Type, T2.Type)> {
        return View(
            registry: self,
            componentTypes: [
    ...
    @inline(__always)
    public func view<T1: Component, T2: Component, T3: Component>(
        requiring component1: T1.Type,
        _ component2: T2.Type,
        _ component3: T3.Type
    ) -> View<(T1.Type, T2.Type, T3.Type)> {
        return View(
            registry: self,
            componentTypes: [
                ObjectIdentifier(T1.self),
